...
function school_zone_customize_register( $wp_customize ){
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Documentation', 'school-zone' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/documentation/school-zone/' ) . '" target="_blank">' . __( 'Click here', 'school-zone' ) . '</a></span><br />';
