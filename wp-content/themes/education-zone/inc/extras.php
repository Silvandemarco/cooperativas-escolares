    ...
    <div class="page-header">
		<div class="container">
            ...
            if( is_search() ){ 
                global $wp_query;    
                ?>
                <h1 class="page-title"><?php printf( esc_html__( '%1$s resultados para "%2$s"', 'education-zone' ), $wp_query->found_posts, get_search_query() ); ?></h1>        		
                <?php                
            }
            ...
            if( is_404() ){ ?>
                <h1 class="page-title"><?php echo esc_html__( 'Erro 404 - Página não encontrada', 'education-zone' ); ?></h1>
            <?php                
            }
    ...
    if( get_theme_mod( 'education_zone_ed_breadcrumb' ) ){
        if ( is_front_page() ) {
            ...
            if ( is_category() ) {
                ...
                echo $before . esc_html__( 'Buscar resultados para "', 'education-zone' ) . esc_html( get_search_query() ) . esc_html__( '"', 'education-zone' ) . $after;
                ...
                echo $before . esc_html__( 'Erro 404 - Página não encontrada', 'education-zone' ) . $after;
            } elseif( is_home() ){
                echo $before;
                single_post_title();
                echo $after;
...
?>
    ...
    <footer class="comment-meta">
    	...
    	<?php if ( $comment->comment_approved == '0' ) : ?>
    		<em class="comment-awaiting-moderation"><?php _e( 'Seu comentário aguarda moderação.', 'education-zone' ); ?></em>
    		<br />
    	<?php endif; ?>
...
function education_zone_change_comment_form_default_fields( $fields ){
    ...
    $fields['author'] = '<p class="comment-form-author"><label class="screen-reader-text" for="author">' . esc_html__( 'Name*', 'education-zone' ) . '</label><input id="author" name="author" placeholder="' . esc_attr__( 'Nome*', 'education-zone' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';
    
    $fields['email'] = '<p class="comment-form-email"><label class="screen-reader-text" for="email">' . esc_html__( 'Email*', 'education-zone' ) . '</label><input id="email" name="email" placeholder="' . esc_attr__( 'E-mail*', 'education-zone' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
    
    $fields['url'] = '<p class="comment-form-url"><label class="screen-reader-text" for="url">' . esc_html__( 'Website', 'education-zone' ) . '</label><input id="url" name="url" placeholder="' . esc_attr__( 'Site', 'education-zone' ) . '" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></p>'; 
...
function education_zone_change_comment_form_defaults( $defaults ){
    ...
    $defaults['comment_field'] = '<p class="comment-form-comment"><label class="screen-reader-text" for="comment">' . esc_html__( 'Comment', 'education-zone' ) . '</label><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comentário', 'education-zone' ) . '" cols="45" rows="8" aria-required="true"></textarea></p>';
